...
class ScanView extends StatefulWidget {
  ...
  const ScanView({Key key,this.eventId, this.eventName, this.eventDate, this.eventPoint})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _StateScanView();
  }
}

class _StateScanView extends State<ScanView> {
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Expanded(
                                flex: 1,
                                child: Text(
                                    scanResult != null ? widget.eventPoint.toString() : "000" , style: TextStyle(fontWeight: FontWeight.w400 , fontSize: 18)))
                          ],
                        ),
            ...
            child: Column(
              ...
              children: [
                Container(
                  child: Column(
                    children: <Widget>[
                      Text("Your process is successful.", style: TextStyle(
